...
export const metadata: Metadata = createPageMetadata({
  title: "BOOKIA Publisher: escribe tu primer libro sin experiencia previa",
  description:
    "BOOKIA Publisher de Ramón del Pozo Rott: prólogo, sinopsis y 3 capítulos gratis. La plataforma del ecosistema literario para nuevos autores.",
...
const articleJsonLd = {
  ...
  "@type": "BlogPosting",
  headline: "BOOKIA Publisher: escribe tu primer libro sin experiencia previa",
    ...
    <article className="min-h-screen bg-premium-cream">
      ...
      <header className="bg-gradient-to-br from-slate-900 via-slate-800 to-amber-900/30 text-white py-16 px-4">
        <div className="container-premium max-w-3xl mx-auto text-center">
          <p className="text-amber-400 text-sm font-bold tracking-widest uppercase mb-3">BOOKIA Publisher</p>
          <h1 className="font-serif text-3xl md:text-5xl font-bold mb-4">
            Escribe tu primer libro con BOOKIA Publisher
          </h1>
      ...
      <div className="container-premium max-w-3xl mx-auto py-12 px-4">
        ...
        <p className="text-lg text-stone-700 leading-relaxed mb-6">
          <strong>Tienes una historia dentro. BOOKIA Publisher la saca al mundo.</strong> Es el complemento natural de mi trabajo
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <Link href="/#bookia-publisher" className="btn-premium btn-outline">Ver sección en inicio</Link>
        </div>
      </div>
    </article>
  );
